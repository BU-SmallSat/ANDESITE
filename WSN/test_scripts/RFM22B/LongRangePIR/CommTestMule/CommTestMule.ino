...
double successRate[MOD_NUM][NUM_NODES];
int rssi_avg[100];
double success_msg[MOD_NUM][NUM_NODES];
double fail_msg[MOD_NUM][NUM_NODES];
...
RF22::GFSK_Rb9_6Fd45, RF22::GFSK_Rb19_2Fd9_6, RF22::GFSK_Rb38_4Fd19_6, RF22::GFSK_Rb57_6Fd28_8, RF22::GFSK_Rb125Fd125};
*/
void loop()
{
          int rssi_calc = 0;
          int rssi_val = 0;
          int rssi_counter = 0;
  for(int state = 0; state<MOD_NUM;state++)
  {
