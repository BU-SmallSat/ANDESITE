...
class DeploymentThread(WorkerThread):
    ...
    def loop(self):
        ...
        i = 0
        print(self.Nodes, self.DeployCount)
        Finish = 0
        Success = 0
        while Finish == 0:
            ...
            if not (i >= 3 and self.Nodes[i][0] == 1):
                ...
                if Result[:-2] == (self.ArduinoID+":Failure"):
                    ...
                    self.executiveQueue.put("ED:test")
                    # self.executiveQueue.put(Qstring)
                print(self.Nodes)
