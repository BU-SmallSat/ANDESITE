...
class MPU9250:
    ...
    def __init__(self, address=SLAVE_ADDRESS):
        """
        :param address:  MPU-9250 I2C slave address default:0x68
        """
        self.address = address
        # these all get set in the two config methods
        self.gres = None
        self.ares = None
        self.mres = None
        self.magXcoef = None
    ...
    def configMPU9250(self, gfs, afs):
        """
        # Configure MPU-9250
        :param gfs: Gyro Full Scale Select(default:GFS_250[+250dps])
        :param afs:  Accel Full Scale Select(default:AFS_2G[2g])
        :return:
        """
        if gfs == GFS_250:
    ...
    def configAK8963(self, mode, mfs):
        """
        Configure AK8963
        :param mode: Magneto Mode Select(default:AK8963_MODE_C8HZ[Continous 8Hz])
        :param mfs: Magneto Scale Select(default:AK8963_BIT_16[16bit])
        :return:
        """
    ...
    # brief Check data ready
     ...
     @retval false data is not ready
        :return:
        """
        is_ready = bus.read_byte_data(self.address, INT_STATUS)
        if is_ready & 0x01:
            return True
        else:
            return False
