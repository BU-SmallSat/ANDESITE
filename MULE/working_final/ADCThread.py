...
class ADCThread(WorkerThread):
    ...
    def healthPoll(self):
        ...
        with open(ADCHealthFile, "w") as healthFile:
            healthFile.write("GPS data, gyro data, and accelerometer data")
    ...
    def init(self):
        self.interval = 10 # frequency of the most frequently sampled ADC hardware (
        self.log("Initializing thread with an interval of {0}".format(self.interval))
        ''''
        turn off the iMTQ watchdog timmer
        '''
