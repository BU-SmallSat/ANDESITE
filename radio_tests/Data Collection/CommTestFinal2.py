...
def writeContinue():
    ...
    #ser2.flush()
    #ser3.flush()
    #ser3.write(mystring.encode('utf-8'))
    #ser2.write(mystring.encode('utf-8'))
    ser1.write(mystring.encode('utf-8'))
    threading.Timer(20, writeContinue).start()
...
text_file = open("AndesiteDataRate.txt", 'w')
#time.sleep(60)

#print ("Writing to word doc"), device1
ser1 = serial.Serial(device1, 115200)
#ser2 = serial.Serial(device2, 115200)
#ser3 = serial.Serial(device3, 115200)
