...
// $Id: RF22Router.cpp,v 1.8 2014/04/01 05:06:44 mikem Exp mikem $
...
////////////////////////////////////////////////////////////////////
// Constructors
RF22Router::RF22Router(uint8_t thisAddress, uint8_t slaveSelectPin, uint8_t interrupt) 
    : RF22ReliableDatagram(thisAddress, slaveSelectPin, interrupt)
{
