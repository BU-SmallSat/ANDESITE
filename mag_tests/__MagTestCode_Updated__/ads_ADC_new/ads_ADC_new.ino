...
/*
This is a test for the ADS1248 ADC at a possible 5,10,20,40,80,160HZ data rates.
...
/*
This function sends one of the designated commands to the ADC
*/
...
///*
/*
send command to power cycle the device then indicate we want stop recieving data continuously - required for initialization
*/
    sendCommand(RESET);
    delayMicroseconds(1);
    sendCommand(SDATAC);
...
*/
  ...
  //begin to read data continuously
    sendCommand(RDATAC);
/*
...
void loop(){
  ...
  //read from ADC while data is avialable
