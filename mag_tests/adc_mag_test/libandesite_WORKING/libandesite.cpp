...
const byte writeControl = B11000110;
const byte C0test = B00000001;
const byte C1test = B10110001; //
const byte C2test = B00101000;
...
void acdh_adc_setup(){
    ...
    **/
    SPI.transfer(writeControl);     //0b11000110
    SPI.transfer(C2test);           //0b00101000;   
    SPI.transfer(C1test);           //0b10110001;
    SPI.transfer(C0test);           //0b00000001
    //deselect the chip
    digitalWrite(ACDH_ADC_XSS_PIN, HIGH);  
